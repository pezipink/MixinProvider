...
let referenceBinaries = [ "MixinProvider.dll" ]
// Web site location for the generated documentation
let website = "/MixinProvider"

let githubLink = "http://github.com/pezipink/MixinProvider"

// Specify more information about your project
let info =
  [ "project-name", "MixinProvider"
    "project-author", "pezi_pink"
    "project-summary", "Type provider for generating F# code via compile time metaprograms"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/MixinProvider" ]
